...
namespace Envoy.Config.Cluster.V3 {
    ...
    static OutlierDetectionReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "cm90byKaDQoQT3V0bGllckRldGVjdGlvbhI1Cg9jb25zZWN1dGl2ZV81eHgY",
            ...
            "X2ppdHRlchgWIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvbhJPCitz",
            "dWNjZXNzZnVsX2FjdGl2ZV9oZWFsdGhfY2hlY2tfdW5lamVjdF9ob3N0GBcg",
            "ASgLMhouZ29vZ2xlLnByb3RvYnVmLkJvb2xWYWx1ZTosmsWIHicKJWVudm95",
            "LmFwaS52Mi5jbHVzdGVyLk91dGxpZXJEZXRlY3Rpb25CkgEKJWlvLmVudm95",
            "cHJveHkuZW52b3kuY29uZmlnLmNsdXN0ZXIudjNCFU91dGxpZXJEZXRlY3Rp",
            "b25Qcm90b1ABWkhnaXRodWIuY29tL2Vudm95cHJveHkvZ28tY29udHJvbC1w",
            "bGFuZS9lbnZveS9jb25maWcvY2x1c3Rlci92MztjbHVzdGVydjO6gMjRBgIQ",
            "AmIGcHJvdG8z"));
  ...
  #endif
  {
    ...
    public OutlierDetection(OutlierDetection other) : this() {
      ...
      SuccessfulActiveHealthCheckUnejectHost = other.SuccessfulActiveHealthCheckUnejectHost;
    ...
    /// <summary>Field number for the "successful_active_health_check_uneject_host" field.</summary>
    public const int SuccessfulActiveHealthCheckUnejectHostFieldNumber = 23;
    private static readonly pb::FieldCodec<bool?> _single_successfulActiveHealthCheckUnejectHost_codec = pb::FieldCodec.ForStructWrapper<bool>(186);
    private bool? successfulActiveHealthCheckUnejectHost_;
    /// <summary>
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool? SuccessfulActiveHealthCheckUnejectHost {
      get { return successfulActiveHealthCheckUnejectHost_; }
      set {
    ...
    public bool Equals(OutlierDetection other) {
      ...
      if (SuccessfulActiveHealthCheckUnejectHost != other.SuccessfulActiveHealthCheckUnejectHost) return false;
    ...
    public override int GetHashCode() {
      ...
      if (successfulActiveHealthCheckUnejectHost_ != null) hash ^= SuccessfulActiveHealthCheckUnejectHost.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (successfulActiveHealthCheckUnejectHost_ != null) {
        _single_successfulActiveHealthCheckUnejectHost_codec.WriteTagAndValue(output, SuccessfulActiveHealthCheckUnejectHost);
      }
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      if (successfulActiveHealthCheckUnejectHost_ != null) {
        _single_successfulActiveHealthCheckUnejectHost_codec.WriteTagAndValue(ref output, SuccessfulActiveHealthCheckUnejectHost);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (successfulActiveHealthCheckUnejectHost_ != null) {
        size += _single_successfulActiveHealthCheckUnejectHost_codec.CalculateSizeWithTag(SuccessfulActiveHealthCheckUnejectHost);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(OutlierDetection other) {
      ...
      if (other.successfulActiveHealthCheckUnejectHost_ != null) {
        if (successfulActiveHealthCheckUnejectHost_ == null || other.SuccessfulActiveHealthCheckUnejectHost != false) {
          SuccessfulActiveHealthCheckUnejectHost = other.SuccessfulActiveHealthCheckUnejectHost;
        }
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 186: {
            bool? value = _single_successfulActiveHealthCheckUnejectHost_codec.Read(input);
            if (successfulActiveHealthCheckUnejectHost_ == null || value != false) {
              SuccessfulActiveHealthCheckUnejectHost = value;
            }
            break;
          }
        }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 186: {
            bool? value = _single_successfulActiveHealthCheckUnejectHost_codec.Read(ref input);
            if (successfulActiveHealthCheckUnejectHost_ == null || value != false) {
              SuccessfulActiveHealthCheckUnejectHost = value;
            }
            break;
