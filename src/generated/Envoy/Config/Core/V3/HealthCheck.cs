...
namespace Envoy.Config.Core.V3 {
    ...
    static HealthCheckReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bmZpZy5wcm90bxokZW52b3kvY29uZmlnL2NvcmUvdjMvZXh0ZW5zaW9uLnBy",
            "b3RvGiJlbnZveS90eXBlL21hdGNoZXIvdjMvc3RyaW5nLnByb3RvGhhlbnZv",
            "eS90eXBlL3YzL2h0dHAucHJvdG8aGWVudm95L3R5cGUvdjMvcmFuZ2UucHJv",
            ...
            "bxoXdmFsaWRhdGUvdmFsaWRhdGUucHJvdG8iVgoPSGVhbHRoU3RhdHVzU2V0",
            "EkMKCHN0YXR1c2VzGAEgAygOMiIuZW52b3kuY29uZmlnLmNvcmUudjMuSGVh",
            "bHRoU3RhdHVzQg36QgqSAQciBYIBAhABIqYZCgtIZWFsdGhDaGVjaxI2Cgd0",
            "aW1lb3V0GAEgASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1cmF0aW9uQgr6Qgeq",
            "AQQIASoAEjcKCGludGVydmFsGAIgASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1",
            "cmF0aW9uQgr6QgeqAQQIASoAEjEKDmluaXRpYWxfaml0dGVyGBQgASgLMhku",
            "Z29vZ2xlLnByb3RvYnVmLkR1cmF0aW9uEjIKD2ludGVydmFsX2ppdHRlchgD",
            "IAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvbhIfChdpbnRlcnZhbF9q",
            "aXR0ZXJfcGVyY2VudBgSIAEoDRJDChN1bmhlYWx0aHlfdGhyZXNob2xkGAQg",
            "ASgLMhwuZ29vZ2xlLnByb3RvYnVmLlVJbnQzMlZhbHVlQgj6QgWKAQIQARJB",
            "ChFoZWFsdGh5X3RocmVzaG9sZBgFIAEoCzIcLmdvb2dsZS5wcm90b2J1Zi5V",
            "SW50MzJWYWx1ZUII+kIFigECEAESLgoIYWx0X3BvcnQYBiABKAsyHC5nb29n",
            "bGUucHJvdG9idWYuVUludDMyVmFsdWUSNAoQcmV1c2VfY29ubmVjdGlvbhgH",
            "IAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5Cb29sVmFsdWUSTgoRaHR0cF9oZWFs",
            "dGhfY2hlY2sYCCABKAsyMS5lbnZveS5jb25maWcuY29yZS52My5IZWFsdGhD",
            "aGVjay5IdHRwSGVhbHRoQ2hlY2tIABJMChB0Y3BfaGVhbHRoX2NoZWNrGAkg",
            "ASgLMjAuZW52b3kuY29uZmlnLmNvcmUudjMuSGVhbHRoQ2hlY2suVGNwSGVh",
            "bHRoQ2hlY2tIABJOChFncnBjX2hlYWx0aF9jaGVjaxgLIAEoCzIxLmVudm95",
            "LmNvbmZpZy5jb3JlLnYzLkhlYWx0aENoZWNrLkdycGNIZWFsdGhDaGVja0gA",
            "ElIKE2N1c3RvbV9oZWFsdGhfY2hlY2sYDSABKAsyMy5lbnZveS5jb25maWcu",
            "Y29yZS52My5IZWFsdGhDaGVjay5DdXN0b21IZWFsdGhDaGVja0gAEkAKE25v",
            "X3RyYWZmaWNfaW50ZXJ2YWwYDCABKAsyGS5nb29nbGUucHJvdG9idWYuRHVy",
            "YXRpb25CCPpCBaoBAioAEkgKG25vX3RyYWZmaWNfaGVhbHRoeV9pbnRlcnZh",
            "bBgYIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvbkII+kIFqgECKgAS",
            "PwoSdW5oZWFsdGh5X2ludGVydmFsGA4gASgLMhkuZ29vZ2xlLnByb3RvYnVm",
            "LkR1cmF0aW9uQgj6QgWqAQIqABJEChd1bmhlYWx0aHlfZWRnZV9pbnRlcnZh",
            "bBgPIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvbkII+kIFqgECKgAS",
            "QgoVaGVhbHRoeV9lZGdlX2ludGVydmFsGBAgASgLMhkuZ29vZ2xlLnByb3Rv",
            "YnVmLkR1cmF0aW9uQgj6QgWqAQIqABIjCg5ldmVudF9sb2dfcGF0aBgRIAEo",
            "CUILGAGSx4bYBAMzLjASQAoMZXZlbnRfbG9nZ2VyGBkgAygLMiouZW52b3ku",
            "Y29uZmlnLmNvcmUudjMuVHlwZWRFeHRlbnNpb25Db25maWcSPwoNZXZlbnRf",
            "c2VydmljZRgWIAEoCzIoLmVudm95LmNvbmZpZy5jb3JlLnYzLkV2ZW50U2Vy",
            "dmljZUNvbmZpZxIoCiBhbHdheXNfbG9nX2hlYWx0aF9jaGVja19mYWlsdXJl",
            "cxgTIAEoCBJBCgt0bHNfb3B0aW9ucxgVIAEoCzIsLmVudm95LmNvbmZpZy5j",
            "b3JlLnYzLkhlYWx0aENoZWNrLlRsc09wdGlvbnMSQAofdHJhbnNwb3J0X3Nv",
            "Y2tldF9tYXRjaF9jcml0ZXJpYRgXIAEoCzIXLmdvb2dsZS5wcm90b2J1Zi5T",
            "dHJ1Y3QacgoHUGF5bG9hZBIXCgR0ZXh0GAEgASgJQgf6QgRyAhABSAASEAoG",
            "YmluYXJ5GAIgASgMSAA6LJrFiB4nCiVlbnZveS5hcGkudjIuY29yZS5IZWFs",
            "dGhDaGVjay5QYXlsb2FkQg4KB3BheWxvYWQSA/hCARqeBgoPSHR0cEhlYWx0",
            "aENoZWNrEhkKBGhvc3QYASABKAlCC/pCCHIGwAECyAEAEhsKBHBhdGgYAiAB",
            "KAlCDfpCCnIIEAHAAQLIAQASNwoEc2VuZBgDIAEoCzIpLmVudm95LmNvbmZp",
            "Zy5jb3JlLnYzLkhlYWx0aENoZWNrLlBheWxvYWQSOgoHcmVjZWl2ZRgEIAMo",
            "CzIpLmVudm95LmNvbmZpZy5jb3JlLnYzLkhlYWx0aENoZWNrLlBheWxvYWQS",
            "QwoUcmVzcG9uc2VfYnVmZmVyX3NpemUYDiABKAsyHC5nb29nbGUucHJvdG9i",
            "dWYuVUludDY0VmFsdWVCB/pCBDICKAASUgoWcmVxdWVzdF9oZWFkZXJzX3Rv",
            "X2FkZBgGIAMoCzInLmVudm95LmNvbmZpZy5jb3JlLnYzLkhlYWRlclZhbHVl",
            "dG9idWYuQW55SAA6NprFiB4xCi9lbnZveS5hcGkudjIuY29yZS5IZWFsdGhD",
            "aGVjay5DdXN0b21IZWFsdGhDaGVja0INCgtjb25maWdfdHlwZUoECAIQA1IG",
            "Y29uZmlnGlUKClRsc09wdGlvbnMSFgoOYWxwbl9wcm90b2NvbHMYASADKAk6",
            "L5rFiB4qCihlbnZveS5hcGkudjIuY29yZS5IZWFsdGhDaGVjay5UbHNPcHRp",
            "b25zOiSaxYgeHwodZW52b3kuYXBpLnYyLmNvcmUuSGVhbHRoQ2hlY2tCFQoO",
            "aGVhbHRoX2NoZWNrZXISA/hCAUoECAoQCypgCgxIZWFsdGhTdGF0dXMSCwoH",
            "VU5LTk9XThAAEgsKB0hFQUxUSFkQARINCglVTkhFQUxUSFkQAhIMCghEUkFJ",
            "TklORxADEgsKB1RJTUVPVVQQBBIMCghERUdSQURFRBAFQoQBCiJpby5lbnZv",
            "eXByb3h5LmVudm95LmNvbmZpZy5jb3JlLnYzQhBIZWFsdGhDaGVja1Byb3Rv",
  ...
  #endif
  {
    ...
    public HealthCheck(HealthCheck other) : this() {
      ...
      eventLogger_ = other.eventLogger_.Clone();
    ...
    /// <summary>Field number for the "event_logger" field.</summary>
    public const int EventLoggerFieldNumber = 25;
    private static readonly pb::FieldCodec<global::Envoy.Config.Core.V3.TypedExtensionConfig> _repeated_eventLogger_codec
        = pb::FieldCodec.ForMessage(202, global::Envoy.Config.Core.V3.TypedExtensionConfig.Parser);
    private readonly pbc::RepeatedField<global::Envoy.Config.Core.V3.TypedExtensionConfig> eventLogger_ = new pbc::RepeatedField<global::Envoy.Config.Core.V3.TypedExtensionConfig>();
    /// <summary>
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<global::Envoy.Config.Core.V3.TypedExtensionConfig> EventLogger {
      get { return eventLogger_; }
    }
    ...
    public bool Equals(HealthCheck other) {
      ...
      if(!eventLogger_.Equals(other.eventLogger_)) return false;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      eventLogger_.WriteTo(output, _repeated_eventLogger_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    #endif
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      eventLogger_.WriteTo(ref output, _repeated_eventLogger_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    public int CalculateSize() {
      ...
      size += eventLogger_.CalculateSize(_repeated_eventLogger_codec);
      if (eventService_ != null) {
    ...
    public void MergeFrom(HealthCheck other) {
      ...
      eventLogger_.Add(other.eventLogger_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 202: {
            eventLogger_.AddEntriesFrom(input, _repeated_eventLogger_codec);
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 202: {
            eventLogger_.AddEntriesFrom(ref input, _repeated_eventLogger_codec);
            break;
          }
        }
      }
    ...
    public static partial class Types {
      ...
      #endif
      {
        ...
        public pb::ByteString Binary {
          get { return HasBinary ? (pb::ByteString) payload_ : pb::ByteString.Empty; }
          set {
            payload_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
        ...
        public bool HasBinary {
          get { return payloadCase_ == PayloadOneofCase.Binary; }
        }
